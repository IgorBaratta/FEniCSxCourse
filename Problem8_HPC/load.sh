...
module load fenics-ufcx-main-gcc-12.2.0-4x6sohk
# findutils@4.9.0%gcc@12.2.0 build_system=autotools patches=440b954 arch=linux-centos7-ivybridge
module load findutils-4.9.0-gcc-12.2.0-qcsjvau
# libsigsegv@2.13%gcc@12.2.0 build_system=autotools arch=linux-centos7-ivybridge
module load libsigsegv-2.13-gcc-12.2.0-tj7qljd
# m4@1.4.19%gcc@12.2.0+sigsegv build_system=autotools patches=9dc5fbd,bfdffa7 arch=linux-centos7-ivybridge
module load m4-1.4.19-gcc-12.2.0-t556fki
# libtool@2.4.7%gcc@12.2.0 build_system=autotools arch=linux-centos7-ivybridge
module load libtool-2.4.7-gcc-12.2.0-z2ddq63
# util-macros@1.19.3%gcc@12.2.0 build_system=autotools arch=linux-centos7-ivybridge
module load util-macros-1.19.3-gcc-12.2.0-u23433a
# libpciaccess@0.16%gcc@12.2.0 build_system=autotools arch=linux-centos7-ivybridge
module load libpciaccess-0.16-gcc-12.2.0-uxl4qhb
...
# hwloc@2.9.0%gcc@12.2.0~cairo~cuda~gl~libudev+libxml2~netloc~nvml~oneapi-level-zero~opencl+pci~rocm build_system=autotools libs=shared,static arch=linux-centos7-ivybridge
module load hwloc-2.9.0-gcc-12.2.0-ftuzsyr
# libfabric@1.16.1%gcc@12.2.0~debug~kdreg build_system=autotools fabrics=sockets,tcp,udp arch=linux-centos7-ivybridge
module load libfabric-1.16.1-gcc-12.2.0-ev6cg7r
# autoconf@2.69%gcc@12.2.0 build_system=autotools patches=35c4492,7793209,a49dd5b arch=linux-centos7-ivybridge
module load autoconf-2.69-gcc-12.2.0-xgwbw5v
# automake@1.16.5%gcc@12.2.0 build_system=autotools arch=linux-centos7-ivybridge
module load automake-1.16.5-gcc-12.2.0-qdrhavn
...
# yaksa@0.2%gcc@12.2.0~cuda~rocm build_system=autotools arch=linux-centos7-ivybridge
module load yaksa-0.2-gcc-12.2.0-p34yqat
# mpich@4.0.2%gcc@12.2.0~argobots~cuda+fortran+hwloc+hydra+libxml2+pci~rocm+romio~slurm~two_level_namespace~vci~verbs+wrapperrpath build_system=autotools datatype-engine=auto device=ch4 netmod=ofi patches=d4c0e99 pmi=pmi arch=linux-centos7-ivybridge
module load mpich-4.0.2-gcc-12.2.0-qpk6une
...
module load hdf5-1.12.2-gcc-12.2.0-5fb46ac
...
module load hypre-2.27.0-gcc-12.2.0-ldauji3
# superlu-dist@8.1.2%gcc@12.2.0~cuda~int64~ipo~openmp~rocm+shared build_system=cmake build_type=RelWithDebInfo arch=linux-centos7-ivybridge
module load superlu-dist-8.1.2-gcc-12.2.0-mkoywvb
...
module load petsc-3.18.2-gcc-12.2.0-6tvr77m
